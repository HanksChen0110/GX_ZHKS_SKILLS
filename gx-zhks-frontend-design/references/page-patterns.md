...
- Shell: dark sidebar + light workspace.
...
- Bottom composer: white prompt bar with embedded dark send button.
...
- Always produce at least one desktop and one mobile screenshot for visual QA.
